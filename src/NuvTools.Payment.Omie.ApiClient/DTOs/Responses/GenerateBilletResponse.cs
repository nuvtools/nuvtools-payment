...
public class GenerateBilletResponse : IOmieBusinessStatus
{
    ...
    // Note: Omie uses "cDesStatus" (without the second "c" in "Desc") in the
    // billet endpoints. Mapping to anything else returns null.
